...
public partial class AppLogic {
	...
	public partial record State : StateLogic, IState {
		public State(IContext context) : base(context) {
			...
			OnExit<State>(
				(next) => appRepo.IsMouseCaptured.Sync -= OnMouseCaptured
			);
		}

		public void OnMouseCaptured(bool isMouseCaptured) => Context.Output(new Output.CaptureMouse(isMouseCaptured));
	}
}
